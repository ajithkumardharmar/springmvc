...
<link rel="stylesheet" href="src/webapp/assets/css/login.css">
</head>
<body>
	<div class="full">
		<div class="cont">
			...
			<div class="container mt-1">
				<form action="checkUser" method="post" class="was-validated">
					...
					<label class="form-label" for="">Email</label><br> <input
						...
						title="Enter valid email ex(example12@gmail.com)" name="email"
